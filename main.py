...
# Студенты
student_1 = Student('Киану', 'Ривз', 'Муж')
student_1.courses_in_progress += ['Python', 'Git']
student_1.finished_courses += ["Введение в програмирование"]

student_2 = Student('Натали', 'Портман', 'Жен')
student_2.courses_in_progress += ['Python', 'Git']
student_2.finished_courses += ["Введение в програмирование"]

# Лекторы
lecturer_1 = Lecturer('Брэд', 'Пит')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Анджелина', 'Джоли')
lecturer_2.courses_attached += ['Python']

# Проверяющие
reviewer_1 = Reviewer('Том', 'Круз')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Скарлет', 'Йохансон')
...
# Оценки лекторам
student_1.rate_lw(lecturer_1, 'Python', 4)
...
print(student_2)
print('')
print('Средняя оценка при сравнении у Студентов:')
print(average_rating_for_course('Python', student_list))
print('Средняя оценка при сравнении у Лекторов:')
